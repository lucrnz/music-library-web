...
/**
 * @returns {Promise<{ usage: number, quota: number, usageDetails?: object, supported: boolean }>}
 */
...
/**
 * @param {{ usage: number, quota: number, supported: boolean }} est
 */
export function isNearQuota(est) {
 ...
 */
export function formatDownloadsStorageLine(d, style = "long") {
