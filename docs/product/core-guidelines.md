...
- **CD playback:** narrower Desktop-PWA feature (Mac now). Red Book WAV deck plus Yellow Book data-CD file playback through the companion, no rip. Yellow Book playable kinds (including WMA) stay off the library index. See `docs/systems/cd-playback.md`.
